...
% =============================================================================
\newcommand{\PFEType}{RAPPORT DE STAGE DE FIN D'ÉTUDES}
\newcommand{\PFEDiplomeIntro}{Pour l'obtention du diplôme de}
\newcommand{\PFEDiplome}{La Licence Appliquée en Informatique Décisionnelle}
\newcommand{\PFETitre}{Titre du rapport sur plusieurs lignes si nécessaire}
\newcommand{\PFEEntrepriseLabel}{Entreprise d'accueil :}
\newcommand{\PFEEntreprise}{Nom de l'entreprise}
\newcommand{\PFEEncadrantPedago}{Prénom Nom}
\newcommand{\PFEEncadrantPro}{Prénom Nom}
\newcommand{\PFEAuteurs}{Prénom Nom}
\newcommand{\PFEAnnee}{2025--2026}

% Logo : fichier \texttt{figures/logo-isg.pdf} ou \texttt{.png} (créez le dossier \texttt{figures/}).
\newcommand{\PFELogoFile}{figures/logo-isg}
\newcommand{\PFECoverLogo}{%
  \IfFileExists{\PFELogoFile.pdf}{%
    \includegraphics[width=4.6cm]{\PFELogoFile.pdf}}{%
  \IfFileExists{\PFELogoFile.png}{%
    \includegraphics[width=4.6cm]{\PFELogoFile.png}}{%
  \begin{minipage}[c]{4.8cm}
    \centering
    \textcolor{ISGTeal}{\rule{\linewidth}{5pt}}\\[3pt]
    {\color{ISGGray}\footnotesize\textit{Logo : \texttt{\PFELogoFile.pdf/.png}}}\\[2pt]
    \textcolor{ISGPink}{\rule{0.55\linewidth}{2pt}}
  \end{minipage}%
  }%
  }%
}
...
\input{def/pfe-tuberlin-cover.tex}
...
\begin{titlepage}
  \thispagestyle{empty}
  \vspace*{-12mm}
  \noindent{\color{ISGTeal}\rule{\linewidth}{2.8pt}}
  \begin{center}
    \vspace{0.9cm}
    \PFECoverLogo\\[1.1cm]
    {\color{ISGPink}\rule{0.42\textwidth}{1.1pt}}\\[1.1cm]
    {\Large\bfseries\color{TitreGris}\PFEType}\\[0.75cm]
    {\large\color{ISGGray}\PFEDiplomeIntro}\\[0.25cm]
    {\large\bfseries\color{TitreGris}\PFEDiplome}\\[1.35cm]
    {\LARGE\bfseries\color{TitreGris}\PFETitre}\\[1.85cm]
    {\large\color{ISGGray}\PFEEntrepriseLabel}\\[0.15cm]
    {\large\bfseries\color{TitreGris}\PFEEntreprise}\\[1.35cm]
    \begin{minipage}[t]{0.45\textwidth}
      \centering
      \textbf{\color{TitreGris}Encadrant pédagogique}\\[0.35cm]
      \color{ISGGray}\PFEEncadrantPedago
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.45\textwidth}
      \centering
      \textbf{\color{TitreGris}Encadrant professionnel}\\[0.35cm]
      \color{ISGGray}\PFEEncadrantPro
    \end{minipage}\\[1.35cm]
    {\large\bfseries\color{TitreGris}Élaboré par}\\[0.25cm]
    {\large\color{ISGGray}\PFEAuteurs}\\[1cm]
    {\large\bfseries\color{TitreGris}Année universitaire}\\[0.15cm]
    {\large\color{ISGGray}\PFEAnnee}
    \vfill
    {\color{ISGRed}\rule{\linewidth}{0.9pt}}
  \end{center}
\end{titlepage}
...
% ----- Remerciements -----
\input{chapters/chapitre-remerciements}

\cleardoublepage

% ----- Dédicaces -----
\input{chapters/chapitre-dedicaces-khalil}
\input{chapters/chapitre-dedicaces-malek}
...
\input{chapters/liste-abreviations}
\cleardoublepage
...
\input{chapters/chapitre-01-etude-prealable}

\input{chapters/chapitre-02-fondation-initiation}

\input{chapters/chapitre-03-sprint1-utilisateurs}

\input{chapters/chapitre-04-sprint2-plans-activites}


\input{chapters/chapitre-059-sprint3-workflow-transverse}
...
% ----- Conclusion générale -----
\cleardoublepage
\input{chapters/chapitre-conclusion}
...
% ----- Annexes -----
\appendix
\input{annexes/annexe-01-premiere}
\input{annexes/annexe-02-deuxieme}
